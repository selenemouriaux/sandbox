...
- Faire un schéma du DOM :
    - Représenter la découpe HTML, en indiquant les balises qui seront utilisées et présciser classes et id


- Ecrire le HTML en premier :
    - Toujours commencer par le HTML car on va d'abord écrire le contenu et ensuite poser le design
    - Utiliser les balises sémantiques en priorité, et ensuite les balises génériques (div, span)
